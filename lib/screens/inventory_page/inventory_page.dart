                                         ...
                                         children: [
                                                   ...
                                                   Padding(
                                                     ...
                                                     child: Container(
                                                       ...
                                                       child: FlutterFlowIconButton(
                                                         ...
                                                         onPressed: () async {
                                                           showDialog(context: context, builder: (context) => const AddNewComponentPage());
                                           ...
                                           Padding(
                                             ...
                                             child: FlutterFlowIconButton(
                                               ...
                                               onPressed: () {
                                                 AppCubit.get(context).getListOfComponents(page: AppCubit.get(context).getListOfInventoryComponentsModel!.current);
                                               },
                                             ),
                                           ),
                                         ],

        ...
        if (state is AppDeleteCarSuccessState) {
          if (state.userDeleted) {
            AppCubit.get(context)
                .getUsers(page: AppCubit.get(context).getUsersModel!.current);
          }
        }
      },
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                ...
                                children: [
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  ConditionalBuilder(
                                                    condition: state
                                                            is AppGetUsersLoadingState ||
                                                        state
                                                            is AppSearchUsersLoadingState,
                                                    builder: (context) =>
                                                        const Center(
                                                      child: Padding(
                                  ...
                                  if (state is! AppGetUsersLoadingState &&
                                      state is! AppSearchUsersLoadingState)
                                    Center(
                                      child: Pager(

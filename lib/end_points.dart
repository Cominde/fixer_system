...
const GETUSERS='${baseUrl}User?page=';
const CHANGESERVICE='${baseUrl}repairing/';
const GETWORKERS='${baseUrl}Worker?page=';
const ADDWORKER='${baseUrl}Worker';
const GETCARS='${baseUrl}Garage?page=';
const GETREPAIRINGCARS='${baseUrl}Garage/repairing?page=';
const SEARCHWORKERS='${baseUrl}Worker/search/';
const SEARCHCARS='${baseUrl}Garage/search/';
const SEARCHUSERS='${baseUrl}User/search/';
const GETLISTOFCOMPONETS='${baseUrl}Inventort?page=';
